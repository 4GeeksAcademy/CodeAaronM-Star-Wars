...
export const Navbar = (props) => {
	...
	const ve1 = [sessionStorage.getItem("ve4")];
	const ve2 = [sessionStorage.getItem("ve6")];
	const ve3 = [sessionStorage.getItem("ve7")];
	const ve4 = [sessionStorage.getItem("ve8")];
	const ve5 = [sessionStorage.getItem("ve14")];
